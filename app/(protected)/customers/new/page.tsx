  ...
  async function onSubmit(values: FormSchema) {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          title: "Success",
          content: "Customer added successfully!", // Replaced `description` with `content`
        });
        ...
        toast({
          title: "Error",
          content: errorData.message || "Failed to add customer.", // Replaced `description` with `content`
          variant: "destructive",
        });
      }
    } catch (error) {
